export const premiumListings = [
  {
    ...
    manufacturer: "Swiss Stone Masons",
    enquiries: "21",
    location: "Durban North, KZN",
    distance: "38km from you",
    description: "Crafted from high-quality polished granite and marble, this timeless tombstone features a sleek rectangular base with a raised cover slab and a striking upright headstone. The beautiful two-tone design is accented by a bold inlaid granite cross, offering a dignified and lasting tribute. With its rich, natural stone patterns and durable construction, this monument is designed to honor your loved one with grace and permanence.",
    tombstoneType: "Full Tombstone",
    style: "Christian Cross",
    stoneType: "Granite / Marble Mix",
    culture: "Christian",
    colour: {
      black: true,
      gold: true
    ...
    customisation: {
      photoEngraving: true,
      builtInFlowerVase: true
    },
    additionalDetails: [
      "Free Transport and Installation within a 20km radius of Factory",
      "Final Transport and installation cost to be confirmed by Manufacturer",
      "No Foundation costs included in price"
    ],
    tag: "HeartFelt Memory",
    tagColor: "bg-memoryPink",
    tagRingColor: "pink-400",
    similarProducts: [
      {
        id: "product-1",
        name: "Full Tombstone",
...
export const manufacturerLogos = {
  "Swiss Stone Masons": "/new files/company logos/Tombstone Manufacturer Logo-SwissStone.svg",
  "Acme Inc.": "/placeholder-logo.svg",
};

export const manufacturerProfileSlugs = {
  "Swiss Stone Masons": "swiss-stone-masons",
  "Acme Inc.": "acme-inc",
  "Marble Masters": "marble-masters",
  "Granite Specialists": "granite-specialists",
  "Family Memorials Ltd": "family-memorials-ltd",
  "Heritage Memorials": "heritage-memorials",
  "Artful Memorials": "artful-memorials",
  "Bronze Crafters": "bronze-crafters",
  "Sacred Stones": "sacred-stones",
  "Comforting Creations": "comforting-creations",
  "Little Angels Memorials": "little-angels-memorials",
};

// Utility to get a slug for any manufacturer name
export function getManufacturerSlug(name) {
  return manufacturerProfileSlugs[name] || name.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '');
}

// Randomize all listings to only two manufacturers
for (let i = 0; i < premiumListings.length; i++) {
  premiumListings[i].manufacturer = i % 2 === 0 ? 'Swiss Stone Masons' : 'Acme Inc.';
}

// Export featured listings (subset of premium listings)
export const featuredListings = premiumListings.slice(0, 3); 