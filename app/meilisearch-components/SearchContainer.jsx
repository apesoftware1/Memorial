...
// import { client } from "@/lib/meilisearch"; // Your configured Meilisearch client
...
//   const selectedCategoryName = desiredOrder[activeTab];
...
//       setIsLoading(true);
//       try {
//         const index = client.index("listing"); // your index name
//         // Search with filter on category, empty query to get all matching
//         console.log(index);
//         const searchResult = await index.search("", {
//           filter: [`title = "${selectedCategoryName}"`],
//           limit: 0, // we don't want actual hits, just metadata
//         });
//         setSearchCount(searchResult.estimatedTotalHits);
//       } catch (error) {
...
//     // Implement your navigation to results page with filters here
//     alert(`Search clicked for category: ${selectedCategoryName}`);
//   };
//   // Refs for dropdowns
...
//         className="bg-[#D4AF37] text-white font-bold py-2 px-4 rounded"
//       >
//         {isLoading
//           ? "Loading..."
//           : searchCount !== null
