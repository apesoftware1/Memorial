...
export const HEAD_STYLE_ICON_MAP = {
  "Christian Cross":
...
export const STONE_TYPE_ICON_MAP = {
  Biodegradable:
...
export const CUSTOMIZATION_ICON_MAP = {
...
export const getIconPath = (type, value) => {
...
export const OPERATING_DAY_ORDER = [
  "monToFri",
  "saturday",
  "sunday",
  "publicHoliday",
